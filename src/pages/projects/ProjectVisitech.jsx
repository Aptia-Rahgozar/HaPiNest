...
import {
  ...
  projectVisitechDesignProcess,
  play,
  projectVisitechMobileHero,
} from "../../assets";

export const ProjectVisitech = ({ title }) => {
  useTitle(title);
          ...
          <div className="p-4 bg-secondaryPink mx-auto min-[768px]:mx-0 shadow-myShadow rounded-2xl">
            ...
            <div className="min-[992px]:text-[18px]">
              ...
              <p className="text-myBlack mb-2.5">
                (A smart and intuitive booking experience for a digital
                healthcare platform)
              </p>
              <p className="text-myBlack mb-2.5">
      ...
      <div className="min-[768px]:flex min-[768px]:h-[600px] gap-6 mt-4">
        ...
        >
          <div className="relative w-full">
            <img
              src={projectVisitechDesignProcess}
              alt="design process"
              className="w-full"
            />
            <div
